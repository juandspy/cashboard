...
from const import BANK_ACCOUNT_NAME, BANK_SUB_ACCOUNT_1_NAME, BANK_SUB_ACCOUNT_2_NAME, OPENING_BALANCE_NAME, ASSETS_NAME, CURRENT_ASSETS_NAME, CASH_ACCOUNT_NAME, EXPENSES_NAME, CAR_EXPENSES_NAME, GAS_EXPENSES_NAME
